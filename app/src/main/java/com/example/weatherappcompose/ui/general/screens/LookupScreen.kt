...
private fun LookupComponents(
    ...
    Column(
        ...
        SearchComponent(viewModel,navigation)
    }
}

@Composable
private fun SearchComponent(viewModel: LookupViewModel = hiltViewModel(),  navigation : (String) -> Unit) {
    ...
    text?.let { SearchButtonComponent(it,viewModel,navigation) }
...
private fun SearchButtonComponent(
    ...
    Button(
        ...
        onClick = {
            viewModel.searchWeather(city,navigation)
        },
